<template>
  <main class="main">
    <Hero
      title="СПА-комплекс"
      subtitle="В парк-отеле «Троя» вы можете отвлечься от суеты и окунуться в атмосферу полного комфорта. Две отдельные зоны отдыха"
      image="/spa/XXXL1.jpg"
      :showBooking="false"
      :images="[
        '/spa/xxxl-slider/1.jpg',
        '/spa/xxxl-slider/2.jpg',
        '/spa/xxxl-slider/3.jpg',
        '/spa/xxxl-slider/4.jpg',
      ]"
      :useSlider="true"
      :sliderDelay="5000"
      align="center"
...
const services = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/spa/sauna-6.jpg", alt: "Бассейн в зоне сауны" },
    ],
    description: [
