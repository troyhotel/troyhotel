<template>
  <div class="video-player" ref="container">
    ...
    <div
      ...
      role="group"
      aria-label="Управление видео"
    >
      <div
        class="video-player__progress-controls-wrapper"
        :class="{
          'video-player__progress-controls-wrapper--fullscreen': isFullscreen,
        }"
      >
        <div class="video-player__controls-bottom">
          <!-- Play / Pause -->
          <button
            class="video-player__control video-player__control--playpause"
            @click="togglePlay"
          ...
          >
            <svg class="video-player__icon" aria-hidden="true">
              <use
                :xlink:href="
                  isPlaying
                    ? '/svg/icons/inlineSprite.svg#pause'
                    : '/svg/icons/inlineSprite.svg#play'
                "
              />
            </svg>
          </button>
          ...
          <!-- Fullscreen -->
          <button
            class="video-player__control video-player__control--fullscreen"
          ...
          >
            <svg class="video-player__icon-fulls" aria-hidden="true">
              <use
                :xlink:href="
                  isFullscreen
                    ? '/svg/icons/inlineSprite.svg#fullscreen-exit'
                    : '/svg/icons/inlineSprite.svg#fullscreen'
                "
              />
            </svg>
          </button>
          <div
            v-if="!isMobile"
            class="video-player__volume-container"
            @mouseenter="showVolume = true"
            @mouseleave="showVolume = false"
          >
            <button
              class="video-player__control video-player__control--mute"
              @click="toggleMute"
            ...
            <input
              ...
              :class="{ 'video-player__volume-slider--visible': showVolume }"
        ...
        <div
          v-if="isFullscreen"
          class="video-player__progress-container"
          @click="seekClick($event)"
        >
          <div
            class="video-player__buffered-bar"
