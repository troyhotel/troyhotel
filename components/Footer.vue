          ...
          <div class="footer__brand">
            ...
            <nav class="footer__social" aria-label="Социальные сети">
              <NuxtLink to="/" class="footer__social-link">
                <svg width="48px" height="48px" id="tg-outline" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <NuxtLink to="/" class="footer__social-link">
                <svg width="48px" height="48px" id="vk-outline" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
